...
const getDaysBetween = (start: Date, end: Date) => {
  ...
  return Math.round(
    Math.abs((start.getTime() - end.getTime()) / millisecondsPerDay)
  );
};
    ...
    <TooltipProvider>
      <Tooltip>
        <TooltipTrigger asChild>
          ...
          >
            <div className="px-2 text-xs text-white truncate whitespace-nowrap">
              {task.title}
            </div>
          </div>
        </TooltipTrigger>
        ...
        <Card className="mb-6 p-4 flex flex-wrap md:flex-nowrap justify-between items-center gap-4">
          <div className="flex items-center gap-2">
            ...
            <Button
              variant="outline"
              size="sm"
              onClick={() => moveDateRange(-daysToShow)}
            >
          ...
          <div className="flex items-center gap-2">
            ...
            >
              <CalendarDays className="h-4 w-4" />2 Weeks
            </Button>
            <Button
              variant="outline"
              size="sm"
